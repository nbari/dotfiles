...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 128 - ((14 * winheight(0) + 9) / 19)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X128
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 155 - ((39 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X155
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 13 - ((12 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X13
...
X    return map(['@echo off', 'for /f "tokens=4" %%a in (''chcp'') do set origchcp=%%a', 'chcp 65001 > nul'] +
X    \ (type(a:cmds) == type([]) ? a:cmds : [a:cmds]) +
X    \ ['chcp %origchcp% > nul'], 'v:val."\r"')
X  endfunction
X
