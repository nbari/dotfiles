...
#	./.vim/view
#	./.vim/view/~=+projects=+rust=+s3m=+src=+lib.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+password.rs=
#	./.vim/view/=+private=+tmp=+bench=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+compound_duration=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+credentials.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+queries.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+encrypt.rs=
#	./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs=
#	./.vim/view/=+private=+tmp=+a.rs=
#	./.vim/view/~=+projects=+rust=+blake2_simd=+blake2b=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+sandbox=+who_am_i=+src=+lib.rs=
#	./.vim/view/~=+rust_files.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+cron-parser=+src=+parser.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+daemon=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+cron-parser=+tests=+tests.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs=
#	./.vim/view/~=+projects=+rust=+cron-parser=+src=+fields.rs=
#	./.vim/view/=+private=+tmp=+sql=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+region.rs=
#	./.vim/view/~=+projects=+rust=+httpwsrep=+src=+options.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+command.rs=
#	./.vim/view/~=+projects=+rust=+rusoto-s3-test=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+xxxx=+src=+main.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortal.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+s3.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+main.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+auth.rs=
#	./.vim/view/~=+projects=+rust=+slick=+src=+envs.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+bin=+assemble.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+dbquota=+src=+bin=+dbquota.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fd=+src=+main.rs=
#	./.vim/view/~=+projects=+sign.io=+token-server=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+dbpulse=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+config.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+nbari=+myip=+yew-app=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+checksum.rs=
#	./.vim/view/~=+projects=+rust=+httpwsrep=+src=+bin=+httpwsrep.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+credentials.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs=
#	./.vim/view/~=+projects=+rust=+molcajete=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+aes.rs=
#	./.vim/view/~=+projects=+rust=+dsn=+tests=+tests.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs=
#	./.vim/view/~=+projects=+rust=+dbpulse=+src=+slack.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+structs.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+s3.rs=
#	./.vim/view/~=+projects=+devops=+ansible=+roles=+haproxy=+sleep.rs=
#	./.vim/view/~=+projects=+rust=+myip=+myip=+src=+main.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+main.rs=
#	./.vim/view/~=+aa.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+config.rs=
#	./.vim/view/~=+projects=+rust=+jroot=+src=+main.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+tests.rs=
#	./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+test.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+signature.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+auth.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+bin=+backend.rs=
#	./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+integration_test.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+compress.rs=
#	./.vim/view/=+private=+tmp=+hello-world=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+archive.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+compress.rs=
#	./.vim/view/~=+projects=+rust=+slick=+src=+precmd.rs=
#	./.vim/view/~=+projects=+rust=+gbump=+tests=+main.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+main.rs=
#	./.vim/view/=+private=+tmp=+async=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+jailctl=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+gbump=+tests=+tests.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs=
#	./.vim/view/=+private=+tmp=+foo=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+crypto.rs=
#	./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortaldir.rs=
#	./.vim/view/~=+projects=+rust=+slick=+src=+prompt.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+auth.rs=
#	./.vim/view/~=+projects=+rust=+gbump=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+backup=+src=+database.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+s3mon.rs=
#	./.vim/view/~=+projects=+rust=+cron-parser=+benches=+parse_benchmark.rs=
#	./.vim/view/~=+projects=+rust=+dbquota=+src=+lib.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+options.rs=
#	./.vim/view/~=+projects=+rust=+dbpulse=+src=+queries.rs=
#	./.vim/view/=+private=+tmp=+ok.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+asm.rs=
#	./.vim/view/~=+projects=+rust=+dbpulse=+src=+bin=+dbpulse.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+struct.rs=
#	./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+libc=+fork=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+dbquota=+src=+queries.rs=
#	./.vim/view/~=+projects=+rust=+httpwsrep=+src=+queries.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+color.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+fork.rs=
#	./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+scan.rs=
#	./.vim/view/~=+projects=+rust=+assemble=+src=+git.rs=
#	./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs=
#	./.vim/view/~=+projects=+rust=+dbpulse=+src=+envs.rs=
#	./.vim/view/~=+projects=+rust=+httpwsrep=+src=+lib.rs=
#	./.vim/view/~=+projects=+sign.io=+backend=+src=+rejections.rs=
...
Xau BufRead,BufNewFile */nginx/* if &ft == '' | setfiletype nginx | endif
...
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+lib.rs='
...
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+password.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+password.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+password.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+password.rs=
echo x - ./.vim/view/=+private=+tmp=+bench=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+bench=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+bench=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 51 - ((35 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X51
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+bench=+src=+main.rs=
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 234 - ((3 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X234
...
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+credentials.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+credentials.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+credentials.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X13
Xnormal! 016|
Xlcd ~/projects/rust/s3m/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+credentials.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+queries.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+queries.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+queries.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+encrypt.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+encrypt.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+encrypt.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 3 - ((2 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X3
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+encrypt.rs=
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs= << 'END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 53 - ((32 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X53
Xnormal! 055|
Xlcd ~/projects/rust/policyd-rate-limit/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs=
echo x - ./.vim/view/=+private=+tmp=+a.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+a.rs= << 'END-of-./.vim/view/=+private=+tmp=+a.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 10 - ((9 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X10
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+a.rs=
echo x - ./.vim/view/~=+projects=+rust=+blake2_simd=+blake2b=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+blake2_simd=+blake2b=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+blake2_simd=+blake2b=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 492 - ((20 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X492
Xnormal! 0
Xlcd ~/projects/rust/blake2_simd/blake2b/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+blake2_simd=+blake2b=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+rust=+sandbox=+who_am_i=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+sandbox=+who_am_i=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+sandbox=+who_am_i=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X30
Xnormal! zo
Xlet s:l = 30 - ((15 * winheight(0) + 9) / 19)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X30
Xnormal! 030|
Xlcd ~/projects/rust/sandbox
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+sandbox=+who_am_i=+src=+lib.rs=
echo x - ./.vim/view/~=+rust_files.rs=
sed 's/^X//' >./.vim/view/~=+rust_files.rs= << 'END-of-./.vim/view/~=+rust_files.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+rust_files.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+src=+parser.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+src=+parser.rs= << 'END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+parser.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X2
Xnormal! 027|
Xlcd ~/projects/rust/cron-parser/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+parser.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+daemon=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+daemon=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+daemon=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 6 - ((5 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X6
Xnormal! 015|
Xlcd ~/projects/go/src/github.com/immortal/sandbox/rust/daemon/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+daemon=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+tests=+tests.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+tests=+tests.rs= << 'END-of-./.vim/view/~=+projects=+rust=+cron-parser=+tests=+tests.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 208 - ((38 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X208
Xnormal! 02|
Xlcd ~/projects/rust/cron-parser/tests
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+cron-parser=+tests=+tests.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 37 - ((29 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X37
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs=
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+src=+fields.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+src=+fields.rs= << 'END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+fields.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 82 - ((20 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X82
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+fields.rs=
echo x - ./.vim/view/=+private=+tmp=+sql=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+sql=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+sql=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 11 - ((10 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X11
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+sql=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+region.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+region.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+region.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 6 - ((5 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X6
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+region.rs=
echo x - ./.vim/view/~=+projects=+rust=+httpwsrep=+src=+options.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+httpwsrep=+src=+options.rs= << 'END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+options.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+options.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+command.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+command.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+command.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 3 - ((2 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X3
Xnormal! 034|
Xlcd ~/projects/rust/assemble
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+command.rs=
echo x - ./.vim/view/~=+projects=+rust=+rusoto-s3-test=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+rusoto-s3-test=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+rusoto-s3-test=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X8
Xnormal! 05|
Xlcd ~/projects/rust/rusoto-s3-test/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+rusoto-s3-test=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+xxxx=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+xxxx=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+xxxx=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X8
Xnormal! 045|
Xlcd ~/projects/rust/xxxx/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+xxxx=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortal.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortal.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortal.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 50 - ((36 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X50
Xnormal! 067|
Xlcd ~/projects/go/src/github.com/immortal/immortal/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortal.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+s3.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+s3.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+s3.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 38 - ((28 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X38
Xnormal! 0
Xlcd ~/projects/rust/assemble/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+s3.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 16 - ((15 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X16
Xnormal! 036|
Xlcd ~/projects/rust/s3mon/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+auth.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+auth.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+auth.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 22 - ((21 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X22
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+auth.rs=
echo x - ./.vim/view/~=+projects=+rust=+slick=+src=+envs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+slick=+src=+envs.rs= << 'END-of-./.vim/view/~=+projects=+rust=+slick=+src=+envs.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 14 - ((13 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X14
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+slick=+src=+envs.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+bin=+assemble.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+bin=+assemble.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+bin=+assemble.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 64 - ((12 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X64
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+bin=+assemble.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+dbquota=+src=+bin=+dbquota.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dbquota=+src=+bin=+dbquota.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+bin=+dbquota.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 36 - ((19 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X36
Xnormal! 043|
Xlcd ~/projects/rust/dbquota
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+bin=+dbquota.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fd=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fd=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fd=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X5
Xnormal! 032|
Xlcd ~/projects/go/src/github.com/immortal/sandbox/rust/fd/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fd=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+token-server=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+token-server=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+token-server=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X5
Xnormal! 023|
Xlcd ~/projects/sign.io/token-server/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+token-server=+src=+main.rs=
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 1 - ((0 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X1
...
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+config.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+config.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+config.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X5
Xnormal! 05|
Xlcd ~/projects/rust/s3m/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+config.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+nbari=+myip=+yew-app=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+nbari=+myip=+yew-app=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+nbari=+myip=+yew-app=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 43 - ((29 * winheight(0) + 17) / 34)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X43
Xnormal! 013|
Xlcd ~/projects/go/src/github.com/nbari/myip/yew-app
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+nbari=+myip=+yew-app=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+checksum.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+checksum.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+checksum.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X9
Xnormal! 040|
Xlcd ~/projects/rust/backup/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+checksum.rs=
echo x - ./.vim/view/~=+projects=+rust=+httpwsrep=+src=+bin=+httpwsrep.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+httpwsrep=+src=+bin=+httpwsrep.rs= << 'END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+bin=+httpwsrep.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+bin=+httpwsrep.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+credentials.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+credentials.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+credentials.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+credentials.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 31 - ((30 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X31
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs=
echo x - ./.vim/view/~=+projects=+rust=+molcajete=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+molcajete=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+molcajete=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X2
Xnormal! 027|
Xlcd ~/projects/rust/molcajete
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+molcajete=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+aes.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+aes.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+aes.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+aes.rs=
echo x - ./.vim/view/~=+projects=+rust=+dsn=+tests=+tests.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+tests=+tests.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dsn=+tests=+tests.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 105 - ((26 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X105
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dsn=+tests=+tests.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs= << 'END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 107 - ((28 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X107
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs=
...
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+structs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+structs.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+structs.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+structs.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+s3.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+s3.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+s3.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+s3.rs=
echo x - ./.vim/view/~=+projects=+devops=+ansible=+roles=+haproxy=+sleep.rs=
sed 's/^X//' >./.vim/view/~=+projects=+devops=+ansible=+roles=+haproxy=+sleep.rs= << 'END-of-./.vim/view/~=+projects=+devops=+ansible=+roles=+haproxy=+sleep.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+devops=+ansible=+roles=+haproxy=+sleep.rs=
echo x - ./.vim/view/~=+projects=+rust=+myip=+myip=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+myip=+myip=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+myip=+myip=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 30 - ((25 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X30
Xnormal! 09|
Xlcd ~/projects/rust/myip/myip/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+myip=+myip=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X7
Xnormal! 029|
Xlcd ~/projects/go/src/github.com/immortal/sandbox/rust/fork/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 119 - ((36 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X119
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+main.rs=
echo x - ./.vim/view/~=+aa.rs=
sed 's/^X//' >./.vim/view/~=+aa.rs= << 'END-of-./.vim/view/~=+aa.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 33 - ((32 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X33
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+aa.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 45 - ((34 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X45
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+config.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+config.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+config.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 41 - ((36 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X41
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+config.rs=
echo x - ./.vim/view/~=+projects=+rust=+jroot=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+jroot=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+jroot=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+jroot=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+tests.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+tests.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+tests.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+tests.rs=
echo x - ./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+test.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+test.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+test.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X6
Xnormal! 05|
Xlcd ~/projects/rust/dsn/src/tests
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+test.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+signature.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+signature.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+signature.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X271
Xnormal! zo
Xlet s:l = 152 - ((14 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X152
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+signature.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+auth.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+auth.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+auth.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+auth.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+bin=+backend.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+bin=+backend.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+bin=+backend.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 93 - ((20 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X93
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+bin=+backend.rs=
echo x - ./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+integration_test.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+integration_test.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+integration_test.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+tests=+integration_test.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+compress.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+compress.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+compress.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+compress.rs=
echo x - ./.vim/view/=+private=+tmp=+hello-world=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+hello-world=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+hello-world=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 1 - ((0 * winheight(0) + 13) / 27)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X1
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+hello-world=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+archive.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+archive.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+archive.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X18
Xnormal! zo
Xlet s:l = 46 - ((36 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X46
Xnormal! 09|
Xlcd ~/projects/rust/assemble/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+archive.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+compress.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+compress.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+compress.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+compress.rs=
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 132 - ((18 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X132
...
echo x - ./.vim/view/~=+projects=+rust=+gbump=+tests=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+gbump=+tests=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+gbump=+tests=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 102 - ((38 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X102
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+gbump=+tests=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+main.rs=
echo x - ./.vim/view/=+private=+tmp=+async=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+async=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+async=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X1
Xnormal! 016|
Xlcd /private/tmp/async/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+async=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+jailctl=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+jailctl=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+jailctl=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+jailctl=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+gbump=+tests=+tests.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+gbump=+tests=+tests.rs= << 'END-of-./.vim/view/~=+projects=+rust=+gbump=+tests=+tests.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X1
Xnormal! 011|
Xlcd ~/projects/rust/gbump/tests
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+gbump=+tests=+tests.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 115 - ((19 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X115
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs=
echo x - ./.vim/view/=+private=+tmp=+foo=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+foo=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+foo=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 26 - ((25 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X26
Xnormal! 06|
Xlcd /private/tmp/foo/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+foo=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+crypto.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+crypto.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+crypto.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 67 - ((39 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X67
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+crypto.rs=
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 244 - ((20 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X244
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortaldir.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortaldir.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortaldir.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+bin=+immortaldir.rs=
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 160 - ((26 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X160
...
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+auth.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+auth.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+auth.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 11 - ((10 * winheight(0) + 12) / 25)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X11
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3m=+src=+auth.rs=
echo x - ./.vim/view/~=+projects=+rust=+gbump=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+gbump=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+gbump=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 233 - ((24 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X233
Xnormal! 044|
Xlcd ~/projects/rust/gbump/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+gbump=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+backup=+src=+database.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+backup=+src=+database.rs= << 'END-of-./.vim/view/~=+projects=+rust=+backup=+src=+database.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+backup=+src=+database.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+s3mon.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+s3mon.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+s3mon.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+bin=+s3mon.rs=
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+benches=+parse_benchmark.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+benches=+parse_benchmark.rs= << 'END-of-./.vim/view/~=+projects=+rust=+cron-parser=+benches=+parse_benchmark.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+cron-parser=+benches=+parse_benchmark.rs=
echo x - ./.vim/view/~=+projects=+rust=+dbquota=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dbquota=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+options.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+options.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+options.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+options.rs=
echo x - ./.vim/view/~=+projects=+rust=+dbpulse=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dbpulse=+src=+queries.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dbpulse=+src=+queries.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 39 - ((21 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X39
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dbpulse=+src=+queries.rs=
echo x - ./.vim/view/=+private=+tmp=+ok.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+ok.rs= << 'END-of-./.vim/view/=+private=+tmp=+ok.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 15 - ((14 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X15
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+ok.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+asm.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+asm.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+asm.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+asm.rs=
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 142 - ((13 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X142
...
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+struct.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+struct.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+struct.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+struct.rs=
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 182 - ((31 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X182
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+libc=+fork=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+libc=+fork=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+libc=+fork=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 44 - ((36 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X44
Xnormal! 027|
Xlcd ~/projects/go/src/github.com/immortal/sandbox/rust/libc/fork/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+libc=+fork=+src=+main.rs=
echo x - ./.vim/view/~=+projects=+rust=+dbquota=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dbquota=+src=+queries.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+queries.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 91 - ((27 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X91
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dbquota=+src=+queries.rs=
echo x - ./.vim/view/~=+projects=+rust=+httpwsrep=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+httpwsrep=+src=+queries.rs= << 'END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+queries.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+queries.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+color.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+color.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+color.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X12
Xnormal! zo
Xlet s:l = 16 - ((15 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X16
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+color.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+fork.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+fork.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+fork.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X3
Xnormal! 011|
Xlcd ~/projects/go/src/github.com/immortal/immortal/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+fork.rs=
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+scan.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+scan.rs= << 'END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+scan.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+immortal=+src=+scan.rs=
echo x - ./.vim/view/~=+projects=+rust=+assemble=+src=+git.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+assemble=+src=+git.rs= << 'END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+git.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 11 - ((10 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X11
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+assemble=+src=+git.rs=
echo x - ./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+rust=+dbpulse=+src=+envs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dbpulse=+src=+envs.rs= << 'END-of-./.vim/view/~=+projects=+rust=+dbpulse=+src=+envs.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 19 - ((18 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X19
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+dbpulse=+src=+envs.rs=
echo x - ./.vim/view/~=+projects=+rust=+httpwsrep=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+httpwsrep=+src=+lib.rs= << 'END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+lib.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+httpwsrep=+src=+lib.rs=
echo x - ./.vim/view/~=+projects=+sign.io=+backend=+src=+rejections.rs=
sed 's/^X//' >./.vim/view/~=+projects=+sign.io=+backend=+src=+rejections.rs= << 'END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+rejections.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 59 - ((33 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X59
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+sign.io=+backend=+src=+rejections.rs=
...
sed 's/^X//' >./.vim/autoload/plug.vim.old << 'END-of-./.vim/autoload/plug.vim.old'
...
Xif s:is_win && &shellslash
X  set noshellslash
X  let s:me = resolve(expand('<sfile>:p'))
X  set shellslash
Xelse
X  let s:me = resolve(expand('<sfile>:p'))
Xendif
...
X
Xif s:is_win
X  function! s:plug_call(fn, ...)
X    let shellslash = &shellslash
X    try
X      set noshellslash
X      return call(a:fn, a:000)
X    finally
X      let &shellslash = shellslash
X    endtry
X  endfunction
...
Xendif
X
Xfunction! s:plug_getcwd()
X  return s:plug_call('getcwd')
Xendfunction
X
Xfunction! s:plug_fnamemodify(fname, mods)
X  return s:plug_call('fnamemodify', a:fname, a:mods)
Xendfunction
X
Xfunction! s:plug_expand(fmt)
X  return s:plug_call('expand', a:fmt, 1)
Xendfunction
X
Xfunction! s:plug_tempname()
X  return s:plug_call('tempname')
Xendfunction
X
Xfunction! plug#begin(...)
X  if a:0 > 0
X    let s:plug_home_org = a:1
X    let home = s:path(s:plug_fnamemodify(s:plug_expand(a:1), ':p'))
...
X  endif
X  if s:plug_fnamemodify(home, ':t') ==# 'plugin' && s:plug_fnamemodify(home, ':h') ==# s:first_rtp
...
X  endif
X  if !has('nvim')
X    \ && (has('win32') || has('win32unix'))
X    \ && !has('multi_byte')
X    return s:err('Vim needs +multi_byte feature on Windows to run shell commands. Enable +iconv for best results.')
X  endif
...
Xfunction! plug#end()
X  if !exists('g:plugs')
X    return s:err('plug#end() called without calling plug#begin() first')
X  endif
X
X  if exists('#PlugLOD')
X    augroup PlugLOD
...
X
X  " Copied from fzf
X  function! s:wrap_cmds(cmds)
X    let cmds = [
X      \ '@echo off',
X      \ 'setlocal enabledelayedexpansion']
X    \ + (type(a:cmds) == type([]) ? a:cmds : [a:cmds])
X    \ + ['endlocal']
X    if has('iconv')
X      if !exists('s:codepage')
X        let s:codepage = libcallnr('kernel32.dll', 'GetACP', 0)
X      endif
X      return map(cmds, printf('iconv(v:val."\r", "%s", "cp%d")', &encoding, s:codepage))
X    endif
X    return map(cmds, 'v:val."\r"')
X  endfunction
X
X  function! s:batchfile(cmd)
...
X    for dir in ['ftdetect', 'ftplugin', 'after/ftdetect', 'after/ftplugin']
...
X    let name = get(opts, 'as', s:plug_fnamemodify(repo, ':t:s?\.git$??'))
...
X      let opts.dir = s:dirpath(s:plug_expand(opts.dir))
X    endif
X  else
...
X    return { 'dir': s:dirpath(s:plug_expand(repo)) }
X  else
X    if repo =~ ':'
X      let uri = repo
X    else
...
X    let docd = join([s:rtp(spec), 'doc'], '/')
...
X  let prev = [&shell, &shellcmdflag, &shellredir]
...
X  let batchfile = ''
X  try
X    let [sh, shellcmdflag, shrd] = s:chsh(a:0)
...
X    if s:is_win
X      let [batchfile, cmd] = s:batchfile(cmd)
X    endif
...
X    let [&shell, &shellcmdflag, &shellredir] = [sh, shellcmdflag, shrd]
X    if s:is_win && filereadable(batchfile)
X      call delete(batchfile)
X    endif
X  endtry
...
X          \ 'git fetch --depth 999999 && git checkout '.plug#shellescape(sha).' --', a:spec.dir)
X  endif
X  return output
Xendfunction
X
...
X        let tag = spec.tag
X        if tag =~ '\*'
X          let tags = s:lines(s:system('git tag --list '.plug#shellescape(tag).' --sort -version:refname 2>&1', spec.dir))
...
X        let out = s:system('git checkout -q '.plug#shellescape(tag).' -- 2>&1', spec.dir)
X      else
X        let branch = get(spec, 'branch', 'master')
X        call s:log4(name, 'Merging origin/'.s:esc(branch))
X        let out = s:system('git checkout -q '.plug#shellescape(branch).' -- 2>&1'
X              \. (has_key(s:update.new, name) ? '' : ('&& git merge --ff-only '.plug#shellescape('origin/'.branch).' 2>&1')), spec.dir)
X      endif
...
X    endif
X    if j.new
X      call s:rm_rf(g:plugs[name].dir)
X    endif
X  endfor
X  let s:jobs = {}
Xendfunction
...
X  let cmd = has_key(a:opts, 'dir') ? s:with_cd(a:cmd, a:opts.dir, 0) : a:cmd
X  let argv = s:is_win ? ['cmd', '/s', '/c', '"'.cmd.'"'] : ['sh', '-c', cmd]
X
X  if s:nvim
X    call extend(job, {
...
X    \ })
X    let jid = s:plug_call('jobstart', argv, job)
X    if jid > 0
X      let job.jobid = jid
X    else
X      let job.running = 0
...
X    endif
X  else
X    let job.lines = s:lines(call('s:system', [cmd]))
...
X  let max = line('$')
X  for i in range(4, max > 4 ? max : 4)
X    if getline(i) =~# '^[-+x*] '.a:name.':'
X      for j in range(i + 1, max > 5 ? max : 5)
X        if getline(j) !~ '^ '
X          return [i, j - 1]
X        endif
X      endfor
...
X          \ prog,
X          \ plug#shellescape(spec.uri, {'script': 0}),
X          \ plug#shellescape(s:trim(spec.dir), {'script': 0})), { 'new': 1 })
X  endif
X
...
Xendfunction
X
Xfunction! s:shellesc_cmd(arg, script)
X  let escaped = substitute('"'.a:arg.'"', '[&|<>()@^!"]', '^&', 'g')
X  return substitute(escaped, '%', (a:script ? '%' : '^') . '&', 'g')
Xendfunction
X
Xfunction! s:shellesc_ps1(arg)
X  return "'".substitute(escape(a:arg, '\"'), "'", "''", 'g')."'"
Xendfunction
X
Xfunction! s:shellesc_sh(arg)
X  return "'".substitute(a:arg, "'", "'\\\\''", 'g')."'"
Xendfunction
X
Xfunction! plug#shellescape(arg, ...)
X  let opts = a:0 > 0 && type(a:1) == s:TYPE.dict ? a:1 : {}
X  let shell = get(opts, 'shell', s:is_win ? 'cmd.exe' : 'sh')
...
X  let script = a:0 > 0 ? a:1 : 1
X  return printf('cd%s %s && %s', s:is_win ? ' /d' : '', plug#shellescape(a:dir, {'script': script}), a:cmd)
Xendfunction
X
Xfunction! s:system(cmd, ...)
X  let batchfile = ''
X  try
X    let [sh, shellcmdflag, shrd] = s:chsh(1)
...
X    call s:system((s:is_win ? 'rmdir /S /Q ' : 'rm -rf ') . plug#shellescape(a:dir))
X  endif
Xendfunction
X
...
X  let allowed = {}
X  for dir in dirs
X    let allowed[s:dirpath(s:plug_fnamemodify(dir, ':h:h'))] = 1
X    let allowed[dir] = 1
...
X  redraw
X  let tmp = s:plug_tempname()
X  let new = tmp . '/plug.vim'
X
X  try
X    let out = s:system(printf('git clone --depth 1 %s %s', plug#shellescape(s:plug_src), plug#shellescape(tmp)))
X    if v:shell_error
...
X  let [cnt, total] = [0, len(g:plugs)]
X  for [name, spec] in items(g:plugs)
X    let is_dir = isdirectory(spec.dir)
...
X    if is_dir && get(s:loaded, name, -1) == 0
X      let unloaded = 1
...
X  try
X    let [sh, shellcmdflag, shrd] = s:chsh(1)
X    let cmd = 'cd '.plug#shellescape(g:plugs[name].dir).' && git show --no-color --pretty=medium '.sha
X    if s:is_win
X      let [batchfile, cmd] = s:batchfile(cmd)
X    endif
...
X      let cmd = 'git log --graph --color=never '
X      \ . (s:git_version_requirement(2, 10, 0) ? '--no-show-signature ' : '')
X      \ . join(map(['--pretty=format:%x01%h%x01%d%x01%s%x01%cr', range], 'plug#shellescape(v:val)'))
X      if has_key(v, 'rtp')
X        let cmd .= ' -- '.plug#shellescape(v.rtp)
X      endif
...
X  endif
X
X  call s:system('git reset --hard HEAD@{1} && git checkout '.plug#shellescape(g:plugs[name].branch).' --', g:plugs[name].dir)
X  setlocal modifiable
X  normal! "_dap
X  setlocal nomodifiable
X  echo 'Reverted'
...
Xlet &cpo = s:cpo_save
Xunlet s:cpo_save
END-of-./.vim/autoload/plug.vim.old
...
X      call add(s:clone_opt, '--no-single-branch')
X    endif
X  endif
X
X  if has('win32unix') || has('wsl')
X    call extend(s:clone_opt, ['-c', 'core.eol=lf', '-c', 'core.autocrlf=input'])
X  endif
X
X  let s:submodule_opt = s:git_version_requirement(2, 8) ? ' --jobs='.threads : ''
X
...
X
Xfunction! s:nvim_cb(job_id, data, event) dict abort
X  return (a:event == 'stdout' || a:event == 'stderr') ?
X    \ s:job_cb('s:job_out_cb',  self, 0, join(a:data, "\n")) :
X    \ s:job_cb('s:job_exit_cb', self, 0, a:data)
Xendfunction
X
...
X
X  if s:nvim
X    if has_key(a:opts, 'dir')
X      let job.cwd = a:opts.dir
X    endif
X    let argv = a:cmd
X    call extend(job, {
X    \ 'on_stdout': function('s:nvim_cb'),
X    \ 'on_stderr': function('s:nvim_cb'),
X    \ 'on_exit':   function('s:nvim_cb'),
X    \ })
X    let jid = s:plug_call('jobstart', argv, job)
X    if jid > 0
...
X    endif
X  elseif s:vim8
X    let cmd = join(map(copy(a:cmd), 'plug#shellescape(v:val, {"script": 0})'))
X    if has_key(a:opts, 'dir')
X      let cmd = s:with_cd(cmd, a:opts.dir, 0)
X    endif
X    let argv = s:is_win ? ['cmd', '/s', '/c', '"'.cmd.'"'] : ['sh', '-c', cmd]
X    let jid = job_start(s:is_win ? join(argv, ' ') : argv, {
X    \ 'out_cb':   function('s:job_cb', ['s:job_out_cb',  job]),
X    \ 'err_cb':   function('s:job_cb', ['s:job_out_cb',  job]),
X    \ 'exit_cb':  function('s:job_cb', ['s:job_exit_cb', job]),
X    \ 'err_mode': 'raw',
X    \ 'out_mode': 'raw'
X    \})
...
X    endif
X  else
X    let job.lines = s:lines(call('s:system', has_key(a:opts, 'dir') ? [a:cmd, a:opts.dir] : [a:cmd]))
X    let job.error = v:shell_error != 0
X    let job.running = 0
X  endif
Xendfunction
...
X      if pull
X        let cmd = ['git', 'fetch']
X        if has_tag && !empty(globpath(spec.dir, '.git/shallow'))
X          call extend(cmd, ['--depth', '99999999'])
X        endif
X        if !empty(prog)
X          call add(cmd, prog)
X        endif
X        call s:spawn(name, cmd, { 'dir': spec.dir })
X      else
X        let s:jobs[name] = { 'running': 0, 'lines': ['Already installed'], 'error': 0 }
X      endif
X    else
...
X    let cmd = ['git', 'clone']
X    if !has_tag
X      call extend(cmd, s:clone_opt)
X    endif
X    if !empty(prog)
X      call add(cmd, prog)
X    endif
X    call s:spawn(name, extend(cmd, [spec.uri, s:trim(spec.dir)]), { 'new': 1 })
X  endif
X
X  if !s:jobs[name].running
X    call s:reap(name)
...
XG_RETRIES = int(vim.eval('get(g:, "plug_retries", 2)')) + 1
XG_TIMEOUT = int(vim.eval('get(g:, "plug_timeout", 60)'))
XG_CLONE_OPT = ' '.join(vim.eval('s:clone_opt'))
XG_PROGRESS = vim.eval('s:progress_opt(1)')
XG_LOG_PROB = 1.0 / int(vim.eval('s:update.threads'))
XG_STOP = thr.Event()
XG_IS_WIN = vim.eval('s:is_win') == '1'
...
X  } if VIM::evaluate('s:mac_gui') == 1
X
X  clone_opt = VIM::evaluate('s:clone_opt').join(' ')
X  progress = VIM::evaluate('s:progress_opt(1)')
X  nthr.times do
X    mtx.synchronize do
X      threads << Thread.new {
...
Xendfunction
X
X" Escape the shell argument based on the shell.
X" Vim and Neovim's shellescape() are insufficient.
X" 1. shellslash determines whether to use single/double quotes.
X"    Double-quote escaping is fragile for cmd.exe.
X" 2. It does not work for powershell.
X" 3. It does not work for *sh shells if the command is executed
X"    via cmd.exe (ie. cmd.exe /c sh -c command command_args)
X" 4. It does not support batchfile syntax.
X"
X" Accepts an optional dictionary with the following keys:
X" - shell: same as Vim/Neovim 'shell' option.
X"          If unset, fallback to 'cmd.exe' on Windows or 'sh'.
X" - script: If truthy and shell is cmd.exe, escape for batchfile syntax.
Xfunction! plug#shellescape(arg, ...)
X  if a:arg =~# '^[A-Za-z0-9_/:.-]\+$'
X    return a:arg
X  endif
X  let opts = a:0 > 0 && type(a:1) == s:TYPE.dict ? a:1 : {}
X  let shell = get(opts, 'shell', s:is_win ? 'cmd.exe' : 'sh')
...
X  try
X    let [sh, shellcmdflag, shrd] = s:chsh(1)
X    if type(a:cmd) == s:TYPE.list
X      " Neovim's system() supports list argument to bypass the shell
X      " but it cannot set the working directory for the command.
X      " Assume that the command does not rely on the shell.
X      if has('nvim') && a:0 == 0
...
X    endif
X    if a:0 > 0
X      let cmd = s:with_cd(cmd, a:1, type(a:cmd) != s:TYPE.list)
X    endif
X    if s:is_win && type(a:cmd) != s:TYPE.list
X      let [batchfile, cmd] = s:batchfile(cmd)
X    endif
X    return system(cmd)
X  finally
...
X      endif
X      if empty(err)
X        let [ahead, behind] = split(s:lastline(s:system([
X        \ 'git', 'rev-list', '--count', '--left-right',
X        \ printf('HEAD...origin/%s', a:spec.branch)
X        \ ], a:spec.dir)), '\t')
X        if !v:shell_error && ahead
X          if behind
X            " Only mention PlugClean if diverged, otherwise it's likely to be
...
Xfunction! s:rm_rf(dir)
X  if isdirectory(a:dir)
X    call s:system(s:is_win
X    \ ? 'rmdir /S /Q '.plug#shellescape(a:dir)
X    \ : ['rm', '-rf', a:dir])
X  endif
Xendfunction
X
...
X
X  try
X    let out = s:system(['git', 'clone', '--depth', '1', s:plug_src, tmp])
X    if v:shell_error
X      return s:err('Error upgrading vim-plug: '. out)
X    endif
X
...
X      let range = origin ? '..origin/'.v.branch : 'HEAD@{1}..'
X      let cmd = ['git', 'log', '--graph', '--color=never']
X      if s:git_version_requirement(2, 10, 0)
X        call add(cmd, '--no-show-signature')
X      endif
X      call extend(cmd, ['--pretty=format:%x01%h%x01%d%x01%s%x01%cr', range])
X      if has_key(v, 'rtp')
X        call extend(cmd, ['--', v.rtp])
X      endif
X      let diff = s:system_chomp(cmd, v.dir)
X      if !empty(diff)
X        let ref = has_key(v, 'tag') ? (' (tag: '.v.tag.')') : has_key(v, 'commit') ? (' '.v.commit) : ''
...
X# bind-key -n C-\ if-shell "$not_tmux" "send-keys C-\\" "select-pane -l"
...
X# bind-key -T copy-mode-vi C-\ select-pane -l
X
...
X
X# Search back to last prompt (mnemonic: "[b]ack"); searches for non-breaking
X# space in prompt.
...
X# exports
X# ----------------------------------------------------------------------------
Xexport PATH="/usr/local/opt/curl/bin:/usr/local/opt/openssl/bin:/usr/local/opt/python/libexec/bin:$HOME/Library/Python/3.7/bin:$HOME/node_modules/.bin:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/usr/share/bin:$PATH:$HOME/projects/go/bin:$HOME/.cargo/bin:$HOME/flutter/bin"
...
Xset listchars=tab:▸\ ,eol:¬,trail:·,extends:#,nbsp:.
X
...
X"let g:syntastic_yaml_checkers = ['yamllint']
...
X    if panels == 1
X        call system("tmux split-window -h -l 75")
X    end
