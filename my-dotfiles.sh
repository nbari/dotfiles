...
sed 's/^X//' >./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs= << 'END-of-./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs='
...
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs=
echo x - ./.vim/view/=+private=+tmp=+fork=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+fork=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+fork=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+fork=+src=+main.rs=
...
sed 's/^X//' >./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs= << 'END-of-./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs=
echo x - ./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs= << 'END-of-./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs=
...
sed 's/^X//' >./.vim/view/=+private=+tmp=+df=+src=+main.rs= << 'END-of-./.vim/view/=+private=+tmp=+df=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/=+private=+tmp=+df=+src=+main.rs=
...
sed 's/^X//' >./.vim/view/~=+tmp=+foo=+src=+main.rs= << 'END-of-./.vim/view/~=+tmp=+foo=+src=+main.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+tmp=+foo=+src=+main.rs=
...
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs=
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs= << 'END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs='
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
END-of-./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs=
...
X      if has_key(opts, opt)
X      \ && (type(opts[opt]) != s:TYPE.string || empty(opts[opt]))
X        throw printf(opt_errfmt, opt, 'string')
X      endif
X    endfor
X    for opt in ['on', 'for']
X      if has_key(opts, opt)
X      \ && type(opts[opt]) != s:TYPE.list
X      \ && (type(opts[opt]) != s:TYPE.string || empty(opts[opt]))
X        throw printf(opt_errfmt, opt, 'string or list')
X      endif
X    endfor
X    if has_key(opts, 'do')
X      \ && type(opts.do) != s:TYPE.funcref
X      \ && (type(opts.do) != s:TYPE.string || empty(opts.do))
