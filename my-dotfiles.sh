...
#	./.vim/view
#	./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs=
#	./.vim/view/=+private=+tmp=+fork=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs=
#	./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs=
#	./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs=
#	./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs=
#	./.vim/view/=+private=+tmp=+df=+src=+main.rs=
...
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs=
#	./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs=
...
echo x - ./.pylintrc
sed 's/^X//' >./.pylintrc << 'f23fa8a1cecaa35b4972bfdd5ca44773'
X[MESSAGES CONTROL]
Xdisable=
...
X    no-member,
X    print-statement,
X    parameter-unpacking,
X    unpacking-in-except,
X    old-raise-syntax,
X    backtick,
X    long-suffix,
X    old-ne-operator,
X    old-octal-literal,
X    import-star-module-level,
X    raw-checker-failed,
X    bad-inline-option,
X    locally-disabled,
X    locally-enabled,
X    file-ignored,
X    suppressed-message,
X    useless-suppression,
X    deprecated-pragma,
X    apply-builtin,
X    basestring-builtin,
X    buffer-builtin,
X    cmp-builtin,
X    coerce-builtin,
X    execfile-builtin,
...
X    getslice-method,
X    setslice-method,
X    no-absolute-import,
X    old-division,
X    dict-iter-method,
X    dict-view-method,
X    next-method-called,
X    metaclass-assignment,
X    indexing-exception,
X    raising-string,
X    reload-builtin,
X    oct-method,
X    hex-method,
...
X    intern-builtin,
X    unichr-builtin,
X    map-builtin-not-iterating,
X    zip-builtin-not-iterating,
X    range-builtin-not-iterating,
X    filter-builtin-not-iterating,
X    using-cmp-argument,
X    eq-without-hash,
X    div-method,
X    idiv-method,
X    rdiv-method,
X    exception-message-attribute,
X    invalid-str-codec,
X    sys-max-int,
X    bad-python3-import,
X    deprecated-string-function,
X    deprecated-str-translate-call,
X    import-error,
X    missing-docstring,
X    invalid-name,
X    bad-whitespace,
X    consider-using-enumeratef23fa8a1cecaa35b4972bfdd5ca44773
echo c - ./.vim
mkdir -p ./.vim > /dev/null 2>&1
echo c - ./.vim/ftdetect
mkdir -p ./.vim/ftdetect > /dev/null 2>&1
echo x - ./.vim/ftdetect/proto.vim
sed 's/^X//' >./.vim/ftdetect/proto.vim << '22f75cb16f8019f1534b716e55bf5c56'
Xaugroup filetype
X    au! BufRead,BufNewFile *.proto setfiletype proto
Xaugroup end
22f75cb16f8019f1534b716e55bf5c56
echo x - ./.vim/filetype.vim
sed 's/^X//' >./.vim/filetype.vim << '7ffbaaea88232e39a01fa814a0ab1b33'
X" adjust the path to your nginx
Xau BufRead,BufNewFile */nginx/* if &ft == '' | setfiletype nginx | endif
7ffbaaea88232e39a01fa814a0ab1b33
echo c - ./.vim/colors
mkdir -p ./.vim/colors > /dev/null 2>&1
echo x - ./.vim/colors/nbari-colors.vim
sed 's/^X//' >./.vim/colors/nbari-colors.vim << 'fd0161d9ba3705c234581fa07b52c760'
X" nbari-colors
X
Xhi clear
Xsyntax reset
...
echo x - ./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+semverbump=+src=+bin=+bump.rs= << '6ab982b508d810202304023bcd9396ee'
...
X54
Xnormal! zo
Xlet s:l = 54 - ((53 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X54
Xnormal! 029|
Xlcd ~/projects/rust/semverbump
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
6ab982b508d810202304023bcd9396ee
echo x - ./.vim/view/=+private=+tmp=+fork=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+fork=+src=+main.rs= << '1102246eb7a795e25f9d1de270a51559'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X7
Xnormal! zo
Xlet s:l = 8 - ((7 * winheight(0) + 9) / 18)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X8
Xnormal! 031|
Xlcd /private/tmp/fork/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
1102246eb7a795e25f9d1de270a51559
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+queries.rs= << '88941357c4cae67dfef8ffff0dc497fd'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 58 - ((36 * winheight(0) + 19) / 39)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X58
Xnormal! 029|
Xlcd ~/projects/rust/policyd-rate-limit/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
88941357c4cae67dfef8ffff0dc497fd
echo x - ./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs=
sed 's/^X//' >./.vim/view/~=+projects=+s3m=+src=+bin=+s3m.rs= << '2ab02f8b46219db42ac6e171107a32a0'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 55 - ((14 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X55
Xnormal! 026|
Xlcd ~/projects/s3m/src/bin
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
2ab02f8b46219db42ac6e171107a32a0
echo x - ./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+diskwatcher=+src=+main.rs= << 'a2cd7c6647f5e3807f38642fb7ee5dad'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 119 - ((23 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X119
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
a2cd7c6647f5e3807f38642fb7ee5dad
echo x - ./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3m=+src=+bin=+s3m.rs= << '8593c5e263b5eecbbac54f2daa1aa0e4'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
X200
Xnormal! zo
Xlet s:l = 139 - ((97 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X139
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
8593c5e263b5eecbbac54f2daa1aa0e4
echo x - ./.vim/view/=+private=+tmp=+df=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+df=+src=+main.rs= << '8934450dd07468654c336a7ddc320332'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 17 - ((16 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X17
Xnormal! 024|
Xlcd /private/tmp/df/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
8934450dd07468654c336a7ddc320332
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+config.rs= << '50aba2af35e7e15d0863324d4a65b245'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 15 - ((14 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X15
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
50aba2af35e7e15d0863324d4a65b245
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+bin=+policyd-rate-limit.rs= << 'e2c1364639de6b4320e749dd30023c65'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 176 - ((25 * winheight(0) + 20) / 40)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X176
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
e2c1364639de6b4320e749dd30023c65
echo x - ./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+go=+src=+github.com=+immortal=+sandbox=+rust=+fork=+src=+main.rs= << 'f2e0e7a55522f6628c54188d7e401d06'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
f2e0e7a55522f6628c54188d7e401d06
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+s3.rs= << 'a712ba7b99b38d1ff109d2f8b80803e3'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 20 - ((19 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X20
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
a712ba7b99b38d1ff109d2f8b80803e3
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+main.rs= << '61320fde00c2709b07ef85c75e185609'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 318 - ((19 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X318
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
61320fde00c2709b07ef85c75e185609
echo x - ./.vim/view/~=+tmp=+foo=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+tmp=+foo=+src=+main.rs= << '3c7c4d31185b76b317fa25677b1923f2'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
3c7c4d31185b76b317fa25677b1923f2
echo x - ./.vim/view/=+private=+tmp=+foo=+src=+main.rs=
sed 's/^X//' >./.vim/view/=+private=+tmp=+foo=+src=+main.rs= << 'ccdd2a254696ac7a0165876d990c87ae'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 9 - ((8 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X9
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
ccdd2a254696ac7a0165876d990c87ae
echo x - ./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+cron-parser=+src=+lib.rs= << 'b1f8bea1e727e1ed204944788454f371'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 54 - ((17 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X54
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
b1f8bea1e727e1ed204944788454f371
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+slack.rs= << '18a0dd2ebcfcbb2aa74abe755641b7d6'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 8 - ((7 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X8
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
18a0dd2ebcfcbb2aa74abe755641b7d6
echo x - ./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+policyd-rate-limit=+src=+main.rs= << 'd6bd0377061d2bd5a47a02e9ad1de607'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 134 - ((13 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X134
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
d6bd0377061d2bd5a47a02e9ad1de607
echo x - ./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+fork=+src=+lib.rs= << '33b1ab7b376f37fa40ccfea425398709'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 10 - ((9 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X10
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
33b1ab7b376f37fa40ccfea425398709
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+structs.rs= << '28f281c3e61aaaca044cefe5d0095552'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 12 - ((11 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X12
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
28f281c3e61aaaca044cefe5d0095552
echo x - ./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+s3mon=+src=+envs.rs= << '0a44273ff81ebf01234620b7e322ad9f'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 1 - ((0 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X1
...
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
0a44273ff81ebf01234620b7e322ad9f
echo x - ./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs=
sed 's/^X//' >./.vim/view/~=+projects=+rust=+dsn=+src=+lib.rs= << '9538e3b4c5a4051950b3fb969671ac63'
Xlet s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
Xargglobal
Xlet s:cpo_save=&cpo
Xset cpo&vim
...
Xsetlocal wrap
Xsetlocal wrapmargin=0
Xlet s:l = 280 - ((33 * winheight(0) + 19) / 38)
Xif s:l < 1 | let s:l = 1 | endif
Xexe s:l
Xnormal! zt
X280
Xnormal! 040|
Xlcd ~/projects/rust/dsn/src
Xlet &so = s:so_save | let &siso = s:siso_save
Xdoautoall SessionLoadPost
X" vim: set ft=vim :
9538e3b4c5a4051950b3fb969671ac63
echo c - ./.vim/autoload
mkdir -p ./.vim/autoload > /dev/null 2>&1
echo x - ./.vim/autoload/plug.vim.old
sed 's/^X//' >./.vim/autoload/plug.vim.old << '13250e08f66387785099f90d8ab96d85'
...
X  let s:me = resolve(expand('<sfile>:p'))
Xendif
Xlet s:base_spec = { 'branch': '', 'frozen': 0 }
Xlet s:TYPE = {
X\   'string':  type(''),
X\   'list':    type([]),
X\   'dict':    type({}),
...
Xendfunction
X
Xfunction! s:git_dir(dir) abort
X  let gitdir = s:trim(a:dir) . '/.git'
X  if isdirectory(gitdir)
X    return gitdir
X  endif
X  if !filereadable(gitdir)
X    return ''
X  endif
X  let gitdir = matchstr(get(readfile(gitdir), 0, ''), '^gitdir: \zs.*')
X  if len(gitdir) && !s:isabsolute(gitdir)
X    let gitdir = a:dir . '/' . gitdir
X  endif
X  return isdirectory(gitdir) ? gitdir : ''
Xendfunction
X
Xfunction! s:git_origin_url(dir) abort
X  let gitdir = s:git_dir(a:dir)
X  let config = gitdir . '/config'
X  if empty(gitdir) || !filereadable(config)
X    return ''
X  endif
X  return matchstr(join(readfile(config)), '\[remote "origin"\].\{-}url\s*=\s*\zs\S*\ze')
Xendfunction
X
Xfunction! s:git_revision(dir) abort
X  let gitdir = s:git_dir(a:dir)
X  let head = gitdir . '/HEAD'
X  if empty(gitdir) || !filereadable(head)
X    return ''
X  endif
X
X  let line = get(readfile(head), 0, '')
X  let ref = matchstr(line, '^ref: \zs.*')
X  if empty(ref)
X    return line
X  endif
X
X  if filereadable(gitdir . '/' . ref)
X    return get(readfile(gitdir . '/' . ref), 0, '')
X  endif
X
X  if filereadable(gitdir . '/packed-refs')
X    for line in readfile(gitdir . '/packed-refs')
X      if line =~# ' ' . ref
X        return matchstr(line, '^[0-9a-f]*')
X      endif
X    endfor
X  endif
X
...
Xendfunction
X
Xfunction! s:git_local_branch(dir) abort
X  let gitdir = s:git_dir(a:dir)
X  let head = gitdir . '/HEAD'
X  if empty(gitdir) || !filereadable(head)
X    return ''
X  endif
X  let branch = matchstr(get(readfile(head), 0, ''), '^ref: refs/heads/\zs.*')
X  return len(branch) ? branch : 'HEAD'
Xendfunction
X
Xfunction! s:git_origin_branch(spec)
X  if len(a:spec.branch)
X    return a:spec.branch
X  endif
X
X  " The file may not be present if this is a local repository
X  let gitdir = s:git_dir(a:spec.dir)
X  let origin_head = gitdir.'/refs/remotes/origin/HEAD'
X  if len(gitdir) && filereadable(origin_head)
X    return matchstr(get(readfile(origin_head), 0, ''),
X                  \ '^ref: refs/remotes/origin/\zs.*')
X  endif
X
X  " The command may not return the name of a branch in detached HEAD state
X  let result = s:lines(s:system('git symbolic-ref --short HEAD', a:spec.dir))
X  return v:shell_error ? '' : result[-1]
Xendfunction
X
Xif s:is_win
...
X  catch
X    return s:err(repo . ' ' . v:exception)
X  endtry
Xendfunction
X
...
X  let opt_errfmt = 'Invalid argument for "%s" option of :Plug (expected: %s)'
X  if type == s:TYPE.string
X    if empty(a:arg)
X      throw printf(opt_errfmt, 'tag', 'string')
X    endif
X    let opts.tag = a:arg
X  elseif type == s:TYPE.dict
X    for opt in ['branch', 'tag', 'commit', 'rtp', 'dir', 'as']
X      if has_key(a:arg, opt)
X      \ && (type(a:arg[opt]) != s:TYPE.string || empty(a:arg[opt]))
X        throw printf(opt_errfmt, opt, 'string')
X      endif
X    endfor
X    for opt in ['on', 'for']
X      if has_key(a:arg, opt)
X      \ && type(a:arg[opt]) != s:TYPE.list
X      \ && (type(a:arg[opt]) != s:TYPE.string || empty(a:arg[opt]))
X        throw printf(opt_errfmt, opt, 'string or list')
X      endif
X    endfor
X    if has_key(a:arg, 'do')
X      \ && type(a:arg.do) != s:TYPE.funcref
X      \ && (type(a:arg.do) != s:TYPE.string || empty(a:arg.do))
X        throw printf(opt_errfmt, 'do', 'string or funcref')
X    endif
...
X  endif
X
X  nnoremap <silent> <buffer> q :call <SID>close_pane()<cr>
X  if a:0 == 0
...
X  let output = s:git_revision(a:spec.dir)
X  if !empty(output) && !s:hash_match(sha, s:lines(output)[0])
X    let credential_helper = s:git_version_requirement(2) ? '-c credential.helper= ' : ''
X    let output = s:system(
X          \ 'git '.credential_helper.'fetch --depth 999999 && git checkout '.plug#shellescape(sha).' --', a:spec.dir)
X  endif
X  return output
Xendfunction
X
...
X      else
X        let branch = s:git_origin_branch(spec)
...
X    if empty(error)
X      if pull
X        let cmd = s:git_version_requirement(2) ? ['git', '-c', 'credential.helper=', 'fetch'] : ['git', 'fetch']
...
X    let result = [s:git_local_branch(a:spec.dir), s:git_origin_url(a:spec.dir)]
...
X      let sha = s:git_revision(a:spec.dir)
X      if empty(sha)
...
X      let current_branch = result[0]
X      " Check tag
X      let origin_branch = s:git_origin_branch(a:spec)
...
X                  \ .'Backup local changes and run PlugClean and PlugUpdate to reinstall it.', origin_branch, ahead, behind)
X          else
X            let err = printf("Ahead of origin/%s by %d commit(s).\n"
X                  \ .'Cannot update until local changes are pushed.',
X                  \ origin_branch, ahead)
X          endif
X        endif
X      endif
X    endif
...
X        else
X          delete _
X          call append(l1 - 1, s:format_message('x', line[1:], err))
X          let l2 += len(s:lines(err))
X          let err_count += 1
X        endif
X        let msg = printf('Removed %d directories.', s:clean_count)
X        if err_count > 0
X          let msg .= printf(' Failed to remove %d directories.', err_count)
X        endif
X        call setline(4, msg)
X        setlocal nomodifiable
X      endif
X    endif
X    let l1 += 1
...
X    for [k, v] in plugs
X      let branch = s:git_origin_branch(v)
X      if len(branch)
X        let range = origin ? '..origin/'.branch : 'HEAD@{1}..'
...
X    let sha = s:git_revision(g:plugs[name].dir)
X    if !empty(sha)
...
Xlet &cpo = s:cpo_save
Xunlet s:cpo_save
13250e08f66387785099f90d8ab96d85
echo x - ./.vim/autoload/plug.vim
sed 's/^X//' >./.vim/autoload/plug.vim << 'c2a8fc46214ca5e7adb9bac534417b1c'
X" vim-plug: Vim plugin manager
X" ============================
X"
X" Download plug.vim and put it in ~/.vim/autoload
...
X    let home = s:path(g:plug_home)
X  elseif has('nvim')
X    let home = stdpath('data') . '/plugged'
X  elseif !empty(&rtp)
X    let home = s:path(split(&rtp, ',')[0]) . '/plugged'
X  else
X    return s:err('Unable to determine plug home. Try calling plug#begin() with a path argument.')
...
Xlet &cpo = s:cpo_save
Xunlet s:cpo_save
c2a8fc46214ca5e7adb9bac534417b1c
echo c - ./.vim/after
...
sed 's/^X//' >./.vim/after/syntax/python.vim << '4a77d285142f7d2632e267aebbf79b87'
Xsyn region Comment start=/"""/ end=/"""/
Xsyn region Comment start=/'''/ end=/'''/
4a77d285142f7d2632e267aebbf79b87
echo x - ./.vim/after/syntax/php.vim
sed 's/^X//' >./.vim/after/syntax/php.vim << '71dd8043550d86b97ed44fcd1c1abad5'
X" syn match phpParent #;$#
71dd8043550d86b97ed44fcd1c1abad5
echo c - ./.vim/syntax
mkdir -p ./.vim/syntax > /dev/null 2>&1
echo x - ./.vim/syntax/haproxy.vim
sed 's/^X//' >./.vim/syntax/haproxy.vim << '08e46ea0394db4fdc22988d72e029566'
X" Vim syntax file
X" Language:    HAproxy
...
X" vim: ts=8
08e46ea0394db4fdc22988d72e029566
echo x - ./.vim/syntax/jquery.vim
sed 's/^X//' >./.vim/syntax/jquery.vim << 'b8b2a6bbbb03de2e58d37dc0c64c8a2e'
X" Vim syntax file
X" Language:    jQuery
X" Maintainer:  Bruno Michel <brmichel@free.fr>
...
b8b2a6bbbb03de2e58d37dc0c64c8a2e
echo x - ./.vim/syntax/php.vim
sed 's/^X//' >./.vim/syntax/php.vim << '6f3c84f9c03a167b3ad503523c5fbf80'
X" Vim syntax file
...
6f3c84f9c03a167b3ad503523c5fbf80
echo x - ./.vim/syntax/proto.vim
sed 's/^X//' >./.vim/syntax/proto.vim << '8277f3e5b02277198df7fea77325d4e4'
...
8277f3e5b02277198df7fea77325d4e4
echo x - ./.vim/syntax/nginx.vim
sed 's/^X//' >./.vim/syntax/nginx.vim << '7a47131166dea140b20961e7d80339e3'
X" Vim syntax file
...
7a47131166dea140b20961e7d80339e3
echo x - ./.tmux.conf
sed 's/^X//' >./.tmux.conf << '25b1c1ee4ff002d0fee5a8d0e4c2dee2'
X# zsh
Xset-option -g default-shell /opt/homebrew/bin/zsh
...
X  set -u status on \;\
X  refresh-client -S
25b1c1ee4ff002d0fee5a8d0e4c2dee2
echo x - ./.zshrc
...
Xfi
f7866ff649bfc3be0a1f466f1e1f7a8c
echo x - ./.cshrc
sed 's/^X//' >./.cshrc << 'c75faa6f3c066675eca88c31617d0f18'
...
X\timing
X\x auto
55acf32155984e27360025e89d733ff7
echo x - ./.tmux-remote.conf
sed 's/^X//' >./.tmux-remote.conf << '567b42b6001f0afcef621bf1a493b7d3'
X# vi bindings
Xset-option -g status-key vi
Xset-window-option -g mode-keys vi
X
...
X# line color
Xset -g pane-border-style fg=colour235
567b42b6001f0afcef621bf1a493b7d3
echo c - ./.zsh
mkdir -p ./.zsh > /dev/null 2>&1
echo x - ./.zsh/bookmarks
sed 's/^X//' >./.zsh/bookmarks << '26185a287c87ca982baaf388bf461b72'
X#!/usr/bin/env bash
...
Xend
26185a287c87ca982baaf388bf461b72
exit
