...
# exports
# ----------------------------------------------------------------------------
export PATH="/usr/local/opt/openssl/bin:/usr/local/opt/python/libexec/bin:$HOME/Library/Python/3.7/bin:$HOME/node_modules/.bin:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/usr/share/bin:$PATH:$HOME/projects/go/bin:$HOME/.cargo/bin:$HOME/flutter/bin"
