...
# exports
# ----------------------------------------------------------------------------
export PATH="/usr/local/opt/python/libexec/bin:$HOME/Library/Python/3.7/bin:$HOME/node_modules/.bin:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:/usr/share/bin:$PATH:$HOME/projects/go/bin:$HOME/.cargo/bin"
...
function zle-line-init zle-keymap-select {
    PROMPT=$($HOME/projects/rust/slick/target/debug/slick prompt)
  #PROMPT=`$HOME/projects/rust/purs/target/release/purs prompt -k "$KEYMAP" -r "$?"` zle reset-prompt
}
zle -N zle-line-init
